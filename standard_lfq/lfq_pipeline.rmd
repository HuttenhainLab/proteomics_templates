...
### Count unique peptides per experimental condition
```{r}
...
ggplot(unique_counts, aes(x = BioReplicate, y = Unique_Peptide_Count)) +
  ...
  geom_text(aes(label = Unique_Peptide_Count), vjust = 1, color = "black", size = 3) +
  labs(title = "Unique Transitions / Peptide Sequences per Replicate",
       x = "Replicate",
...
Use Ben Polacco's *makeContrast* function to help build the group comparison matrix without errors. Again, you can do this yourself if you're careful without using this function.
