...
utils <- "C:/Users/dainb/OneDrive/Documents/GitHub/bp_utils/"
...
if (export.type == "SP") {
  ...
  spectronaut.phospho.report <- "../../data/MG05_3ul_MsStatsPTM.tsv"
  spectronaut.phospho.annotations <- "../../data/annotations_global.csv"
  ...
  spectronaut.globalproteome.report <- "../../data/MG05A_StandardTolerances_Report.tsv"
